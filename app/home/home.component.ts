...
export class HomeComponent implements OnInit {
    ...
    mjvers: { id: number, name: string, imageSrc: string, customImage: any, status: boolean, freeDay: null }[] = [
...
count = 1;
    shuffle() {
        ...
        let currentIndex = this.mjvers.length, temporaryValue, randomIndex;
