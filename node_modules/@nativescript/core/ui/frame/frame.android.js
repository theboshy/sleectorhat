    ...
    FragmentCallbacksImplementation.prototype.onDestroyView = function (fragment, superFunc) {
        try {
            ...
            if (hasRemovingParent) {
                ...
                this.frame._originalBackground = this.frame.backgroundColor || new frame_common_1.Color("White");
...
var ActivityCallbacksImplementation = (function () {
    ...
    ActivityCallbacksImplementation.prototype.setActivityContent = function (activity, savedInstanceState, fireLaunchEvent) {
        ...
        var rootView = this._rootView;
        if (frame_common_1.traceEnabled()) {
            frame_common_1.traceWrite("Frame.setActivityContent rootView: " + rootView + " shouldCreateRootFrame: false fireLaunchEvent: " + fireLaunchEvent, frame_common_1.traceCategories.NativeLifecycle);
        }
        if (!rootView) {
            ...
            system_classes_1.pushToSystemCssClasses("" + system_classes_1.CLASS_PREFIX + ANDROID_PLATFORM);
            system_classes_1.pushToSystemCssClasses("" + system_classes_1.CLASS_PREFIX + deviceType);
            system_classes_1.pushToSystemCssClasses("" + system_classes_1.CLASS_PREFIX + application.android.orientation);
            system_classes_1.pushToSystemCssClasses("" + system_classes_1.CLASS_PREFIX + application.android.systemAppearance);
